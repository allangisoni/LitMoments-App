...
import com.lit.litmoments.AddJournal.CurrentUserLocation;
import com.lit.litmoments.AddJournal.JournalEntryAdapater;
import com.lit.litmoments.AddJournal.JournalEntryModel;
import com.lit.litmoments.AddJournal.JournalEntryViewHolder;
...
public class AddJournalEntry extends AppCompatActivity implements JournalEntryAdapater.OnClickAction, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    String[] mood = {"Happy", "Sad", "Amused", "Dreamy", "Mysterious", "Romantic"};
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION)
                ...
                if (lm.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    TastyToast.makeText(getApplicationContext(), "Turn on Location", TastyToast.LENGTH_SHORT, TastyToast.INFO);
                }
            }
        }
