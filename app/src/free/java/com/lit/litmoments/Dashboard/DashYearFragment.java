...
public class DashYearFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_dash_year_fragment, container,false);
    ...
    private void getEntryBarChartData( ArrayList<JournalEntryModel> mList){
        ...
        int y2019 =0, y2020 =0, y2021 =0, y2022 =0;
        ...
        for (JournalEntryModel model : mList){
            ...
            else if(calendar.get(Calendar.YEAR) == 2020){
                y2020 +=1;
            }
            else if(calendar.get(Calendar.YEAR) == 2021){
                y2021 +=1;
            }
            else if(calendar.get(Calendar.YEAR) == 2022){
                y2022 +=1;
            }
        ...
        mEntryList.add(new BarEntry(0, y2019));
        mEntryList.add(new BarEntry(1, y2020));
        mEntryList.add(new BarEntry(2, y2021));
        mEntryList.add(new BarEntry(3, y2022));
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    getEntryPieChartData(journalList);
                    getEntryBarChartData(journalList);
