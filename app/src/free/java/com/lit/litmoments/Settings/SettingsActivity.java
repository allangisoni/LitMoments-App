...
//Loads Shared preferences
   ...
   // private FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean img = intent.getBooleanExtra("isPremium", false);

        if(intent.getExtras().getBoolean("isPremium") == true) {
            isPremiumUser = true;
            Log.d("isPremium", img.toString() );
        ...
        bundle.putBoolean("isPremium", isPremiumUser);
        MainPreferenceFragment myFrag = new MainPreferenceFragment();
        myFrag.setArguments(bundle);
        getFragmentManager().beginTransaction().replace(android.R.id.content,myFrag).commit();
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
           ...
           if(b != null)
             isActive = b.getBoolean("isPremium");
            Log.d("isPremiummmm", isActive.toString() );
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            final String SUBSCRIBER_UPLOADS = "Subscription Details";
           ...
           // bindPreferenceSummaryToValue(findPreference(getString(R.string.key_notifications_new_message_ringtone)));
            ...
            prefshare.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    share.putExtra(Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=com.lit.litmoments");
  ...
  **/
    ...
    private void loadUiThemeprem(SharedPreferences sharedPreferences){
    ...
    private void setPremStyle(Boolean isPrem) {
        if(isPrem){
            setTheme(R.style.ReddishLitStyle);
            isWhite=true;
        } else {
            ...
            builder.setMessage("Please subscribe to premium to use this theme")
    ...
    public void onHeaderClick(Header header, int position) {
        ...
        //Toast.makeText(getApplicationContext(), "am good", Toast.LENGTH_LONG).show();
        //header.fragmentArguments.putBoolean("isPremium", isPremiumUser);
