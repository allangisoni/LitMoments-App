...
import com.lit.litmoments.AddJournal.CustomAdapter;
import com.lit.litmoments.AddJournal.CustomMoodAdapter;
...
public class EditJournalEntry extends AppCompatActivity implements DisplayImagesAdapter.OnClickAction, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    **/
        ...
        if(bundle != null) {
            journalEntry = bundle.getParcelable("journalEntry");
            isPremiumUser = bundle.getBoolean("isPremium");
        }
